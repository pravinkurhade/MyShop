...
import com.bsktech.myshop.adaptor.OrderSummaryItemsAdapter.BarcodeFieldViewHolder
...
internal class OrderSummaryItemsAdapter(
    ...
    internal class BarcodeFieldViewHolder private constructor(view: View) :
        ...
        fun bindBarcodeField(
            ...
            size.text = barcodeField.size +" x "+barcodeField.quantity.toString()
