...
class MainMLActivity : AppCompatActivity() {
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        findViewById<RecyclerView>(R.id.mode_recycler_view).apply {
            ...
            layoutManager = LinearLayoutManager(this@MainMLActivity)
    ...
    private inner class ModeItemAdapter internal constructor(private val detectionModes: Array<DetectionMode>) :
        ...
        private inner class ModeItemViewHolder internal constructor(view: View) :
            ...
            internal fun bindDetectionMode(detectionMode: DetectionMode) {
                ...
                itemView.setOnClickListener {
                    val activity = this@MainMLActivity
                    when (detectionMode) {
                        DetectionMode.ODT_LIVE ->
                            activity.startActivity(
                                Intent(
                                    activity,
                                    LiveObjectDetectionActivity::class.java
                                )
                            )
